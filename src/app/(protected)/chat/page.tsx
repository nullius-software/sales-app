...
export default function ChatPage() {
    ...
    useEffect(() => {
        const newMessages = messages.filter(
            (msg) => !visibleMessages.some((m) => m.id === msg.id)
        );
        ...
        newMessages.forEach((msg) => {
            if (msg.from === 'bot') {
                ...
                setTimeout(() => {
                    ...
                    setIsThinking(false);
                }, 1000); // Delay artificial ajustable
            } else {
                setVisibleMessages((prev) => [...prev, msg]);
            }
        });
    ...
    return (
        <div className="flex flex-col flex-1 p-4 bg-gray-50">
            <div className="flex-1 overflow-auto space-y-2 mb-4">
                ...
                {isThinking && (
                    <div className="flex items-start px-4 py-3 rounded-xl text-[15px] leading-relaxed transform transition-all duration-300 max-w-[80%] bg-zinc-100/80 self-start text-gray-500 shadow-sm">
                        <BotIcon />
